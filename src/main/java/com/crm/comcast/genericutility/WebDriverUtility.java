...
public class WebDriverUtility {
   ...
   /**
    * This method wait for the element to be clicked , its custom wait created to avoid elementInterAceptable Exception
    * @param element
    * @throws throwable
    * 
    */
 ...
 */
public void switchto_window(WebDriver driver,String actualtitle) {
